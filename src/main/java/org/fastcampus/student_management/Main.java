...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    CourseInfoDto courseInfoDto = new CourseInfoDto("바이올린", 1000, "MONDAY", "홍길동", 171729908l);
    CourseInfoDto courseInfoDto1 = new CourseInfoDto("첼로", 1000, "MONDAY", "존도", 171729908l);
